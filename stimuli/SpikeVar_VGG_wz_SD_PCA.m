...
VGG16lay1feats = importfile_VGG_feat1([vggdir 'SpikeVar_VGG16_lay1_wz_feature_sd.csv']);
...
VGG16lay2feats = importfile_VGG_feat2([vggdir 'SpikeVar_VGG16_lay2_wz_feature_sd.csv']);
% get rid of first column
VGG16lay2feats(:,1) = [];
% make it an array
...
VGG16lay3feats = importfile_VGG_feat3([vggdir 'SpikeVar_VGG16_lay3_wz_feature_sd.csv']);
% get rid of first column
VGG16lay3feats(:,1) = [];
% make it an array
...
VGG16lay4feats = importfile_VGG_feat4([vggdir 'SpikeVar_VGG16_lay4_wz_feature_sd.csv']);
% get rid of first column
VGG16lay4feats(:,1) = [];
% make it an array
...
VGG16lay5feats = importfile_VGG_feat5([vggdir 'SpikeVar_VGG16_lay5_wz_feature_sd.csv']);
% get rid of first column
VGG16lay5feats(:,1) = [];
% make it an array
...
%% save estimates
save([vggdir 'VGG16_all_encoding_recog_layer1_wz_sd_pc1.mat'], 'VGG1_sd_pc1_table')
save([vggdir 'VGG16_all_encoding_recog_layer2_wz_sd_pc1.mat'], 'VGG2_sd_pc1_table')
save([vggdir 'VGG16_all_encoding_recog_layer3_wz_sd_pc1.mat'], 'VGG3_sd_pc1_table')
save([vggdir 'VGG16_all_encoding_recog_layer4_wz_sd_pc1.mat'], 'VGG4_sd_pc1_table')
save([vggdir 'VGG16_all_encoding_recog_layer5_wz_sd_pc1.mat'], 'VGG5_sd_pc1_table')

save([vggdir 'VGG16_all_encoding_recog_layer1_wz_sd_pcavg.mat'], 'VGG1_sd_pcavg_table')
save([vggdir 'VGG16_all_encoding_recog_layer2_wz_sd_pcavg.mat'], 'VGG2_sd_pcavg_table')
save([vggdir 'VGG16_all_encoding_recog_layer3_wz_sd_pcavg.mat'], 'VGG3_sd_pcavg_table')
save([vggdir 'VGG16_all_encoding_recog_layer4_wz_sd_pcavg.mat'], 'VGG4_sd_pcavg_table')
save([vggdir 'VGG16_all_encoding_recog_layer5_wz_sd_pcavg.mat'], 'VGG5_sd_pcavg_table')

save([vggdir 'VGG16_all_encoding_recog_layer1_wz_sd_pcs.mat'], 'VGG1_sd_pc_table')
save([vggdir 'VGG16_all_encoding_recog_layer2_wz_sd_pcs.mat'], 'VGG2_sd_pc_table')
save([vggdir 'VGG16_all_encoding_recog_layer3_wz_sd_pcs.mat'], 'VGG3_sd_pc_table')
save([vggdir 'VGG16_all_encoding_recog_layer4_wz_sd_pcs.mat'], 'VGG4_sd_pc_table')
save([vggdir 'VGG16_all_encoding_recog_layer5_wz_sd_pcs.mat'], 'VGG5_sd_pc_table')
