function [result_early, result_late, result_all] = run_pls_models(neuro_data, stim_data, n_trials_used)
% run PLS models for early, late and all VGG/HMAX layers
    % set up some more options for PLS
    option = [];
    option.method = 3; % behavioural PLS
    option.num_perm = 10 %1000; % number of permutations
    option.num_boot = 10 %1000; % number of bootstraps
